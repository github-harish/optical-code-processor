...
public enum ResponseEnum {
	...
	ERR_SYSTEM_EXCEPTION("SVC9999", "System Exception"), ERR_FILE_NOT_FOUND("SVC1001",
			"File not Found"), ERR_STREAM_PROCESSING("SVC1002", "Error while processing Stream"), ERR_CODE_PROCESSING(
					"SVC1003", "Error while processing Code"), ERR_IMAGE_DIMENTION_INVALID("SVC1004",
							"Image dimentsion is not valid");
